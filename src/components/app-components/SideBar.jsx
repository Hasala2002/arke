    ...
    <>
      ...
      <div className={styles.RoomInfo}>
        ...
        <QRCode
          ...
          value={`${window.location.origin}/join/${currentUser.roomId}&${secretKey}`}
        />
        <div className={styles.LinkCopy}>
          <span>
            {`${window.location.origin}/join/${currentUser.roomId}&${secretKey}`.substring(
              0,
              20
            ) + "..."}
          </span>
        ...
        <div className={styles.instructionSection}>
          <div className={styles.instructionPoint}>
            ...
            <span className={styles.instructionLine}>
              You are inside a <b>disposable</b> chatroom. Nothing is saved and
              its encrypted too.
            </span>
          </div>
          <div className={styles.instructionPoint}>
            ...
            <span className={styles.instructionLine}>
              Invite anyone to this chatroom by sharing the <b>QR Code</b> above
              or copying the invite link by clicking on the <b>button</b> next
              to the link.
            </span>
          </div>
          <div className={styles.instructionPoint}>
